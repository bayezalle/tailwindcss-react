...
const Billing = () =>  (
   <section id='product' className={layout.sectionReverse}>
      <div className={layout.sectionImgReverse}>
        ...
        <div className='absolute z-[3] -left-1/2top-0 w-[50%] h-[50%] rounded-full white_gradient'/>
        <div className='absolute z-[0] -left-1/2bottom-0 w-[50%] h-[50%] rounded-full pink_gradient'/>
      </div>
      ...
      <div className={layout.sectionInfo}>
          ...
          <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
            ...
            aenea neque. fusce ipsum orci rhoncus aliporttior
            integer integer plates placerat.
          </p>
